...
public class SP360 extends Spider {
    ...
    public String homeVideoContent() throws Exception {
        ...
        for (int i = 0; i < data.length(); i++) {
            ...
            String remark = item.optString("doubanscore");
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> extend) throws Exception {
        ...
        StringBuilder sb = new StringBuilder()
                ...
                .append("&cat=").append(URLEncoder.encode(classType, "UTF-8"))
                .append("&year=").append(year)
                .append("&area=").append(URLEncoder.encode(area, "UTF-8"))
                .append("&act=").append(URLEncoder.encode(actor, "UTF-8"));
        ...
        JSONArray videos = new JSONArray();
        JSONObject data = new JSONObject(reqBusy(cateUrl, "\"msg\":\"ok\""))
                .optJSONObject("data");
        String listtotal = data.optString("total");
        JSONArray items = data.optJSONArray("movies");
        ...
        JSONObject result = new JSONObject();
        result.put("pagecount", (Integer.parseInt(listtotal) + 34) / 35);
        result.put("page", pg);
        result.put("limit", 35);
