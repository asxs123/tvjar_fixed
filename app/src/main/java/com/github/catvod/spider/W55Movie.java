...
//    private static final String siteUrl = "https://55flix.com";
    ...
    //     // 加密
    //     String key = "a67e9a3a85049339";
    //     String iv = "86ad9b37cc9f5b9501b3cecc7dc6377c";
    //     String encrypt = Crypto.aesEncryptPkcs7(encrytStr, key, iv);
    //     String encodeURI = URLEncoder.encode(encrypt, "UTF-8");
    //     // 请求获取url
    //     String data = OkHttp.string("https://player.ddzyku.com:3653/getUrls?data=" + encodeURI);
    //     // 解密
    //     String decrypted = Crypto.aesDecryptPkcs7(data, key, iv);
    //     Gson gson = new Gson();
