...
public class Douban extends Spider {
    ...
    public String homeContent(boolean filter) throws Exception {
        ...
        List<String> typeIds = Arrays.asList("hot_gaia", "tv_hot", "show_hot", "movie_showing", "rank_list_movie", "rank_list_tv", "movie", "tv");
        List<String> typeNames = Arrays.asList("热门电影", "热播剧集", "热播综艺", "影院热映", "电影榜单", "电视剧榜单", "电影筛选", "电视筛选");
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> extend) throws Exception {
        ...
        switch (tid) {
            ...
            case "show_hot":
                ...
                break;
            case "movie_showing":
                cateUrl = siteUrl + "/subject_collection/movie_showing/items" + apikey + "&start=" + start + "&count=20";
                itemKey = "subject_collection_items";
                break;
            case "tv":
