...
@rem ============================================================
@rem  自动检测项目内便携式 JDK (不修改系统环境)
@rem ============================================================
if defined JAVA_HOME goto findJavaFromJavaHome

@rem 尝试 jdk/current 符号链接
...
@rem 也检查 jdk 根目录下是否有 bin\java.exe (非标准布局)
...
echo ================================================================
echo.
echo   请先运行安装脚本下载项目专用 JDK:
echo     python setup_jdk.py
echo.
echo   或手动安装 JDK:
echo     1. 打开 https://adoptium.net/releases.html
echo     2. 下载 Temurin 21 LTS / Windows x64 / JDK
echo     3. 解压到 jdk\ 目录下
echo.
